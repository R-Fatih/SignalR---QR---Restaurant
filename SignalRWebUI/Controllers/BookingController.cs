...
namespace SignalRWebUI.Controllers
{
	public class BookingController : Controller
	{
		...
		{
			var client = _httpClientFactory.CreateClient();
			await client.GetAsync($"https://localhost:7122/api/Booking/BookingStatusApproved/{id}");
		...
		{
			var client = _httpClientFactory.CreateClient();
			await client.GetAsync($"https://localhost:7122/api/Booking/BookingStatusCancelled/{id}");
